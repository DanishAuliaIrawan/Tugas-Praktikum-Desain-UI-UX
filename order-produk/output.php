...
<head>
    ...
    <title>Thank You - Cheese Chicken</title>
    <style>
        body {
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($errors)) {
            ...
            $selected_sauce = [];
            foreach ($sauce as $sauce_item) {
                if (isset($sauce_names[$sauce_item])) {
                    $selected_sauce[] = $sauce_names[$sauce_item];
                }
            }

            if (!empty($selected_sauce)) {
                echo '<div class="info-item"><strong>Sauce:</strong> ' . implode(', ', $selected_sauce) . '</div>';
            } else {
                echo '<div class="info-item"><strong>Sauce:</strong> None</div>';
            }
    ...
    <div class="footer">
        <p>This site is for educational purposes only. No chicken will be delivered.</p>
    </div>
</body>
</html>